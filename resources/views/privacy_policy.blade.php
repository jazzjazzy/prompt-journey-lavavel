<x-policies-layout>
    ...
    <div style="margin: 20px">
        <h1>Prompt Journey Privacy Policy</h1>
        <p>Welcome to Prompt Journey Privacy Policy</p>
        ...
        <ul>
            ...
            <li>Information we collect from third-party sources</li>
        </ul>
        ...
        <p>We do not sell, trade, or otherwise transfer your personally identifiable information to outside parties.
            This
            does not include trusted third parties who assist us in operating our services, conducting our business, or
            servicing you, so long as those parties agree to keep this information confidential.</p>
        <h2>Security</h2>
        <p>We take reasonable steps to protect your information from loss, misuse, and unauthorized access, disclosure,
            alteration, or destruction. However, no Internet transmission is ever completely secure or error-free, and
            we
            cannot guarantee the security of your information.</p>
        <h2>Changes to Our Privacy Policy</h2>
        <p>We may modify or update this Privacy Policy from time to time. If we make any material changes to this
            Privacy
